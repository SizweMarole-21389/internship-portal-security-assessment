...
![Login response shows none of the five security headers](SS-F09-01_missing-security-headers.png)

### 2. Authenticated profile response returns the same minimal headers

![Authenticated profile response returns the same minimal headers](SS-F09-02_missing-headers-api.png)
